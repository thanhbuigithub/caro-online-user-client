...
const useStyles = makeStyles((theme) => ({
  ...
  tittle: {
    background:
      "linear-gradient(to left,rgba(116,235,213,0.6),rgba(159,172,230,0.6))",
    color: "#5850EC",
...
const RegisterView = () => {
  ...
  return (
    <PageTittle className={classes.root} title="Register">
      <Box
        display="flex"
          ...
          >
            {({
              ...
              <form onSubmit={handleSubmit}>
                <Box
                  textAlign="center"
                  style={{ margin: "-2em -1.5em 0.5em -1.5em" }}
                >
                  <Typography color="textPrimary" className={classes.tittle}>
